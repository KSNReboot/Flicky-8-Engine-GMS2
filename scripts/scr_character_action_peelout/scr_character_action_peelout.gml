...
function scr_character_action_peelout() {
	      ...
	      if(AbilityPeelout == 1){
	         ...
	         // Get Ready to peelout:
	            if(XSpeed == 0 && YSpeed == 0 && KeyUp && KeyAction_Pressed && Action != ActionPeelout){
	               ...
	               PlaySound(snd_character_peelout_charge, global.SFXVolume, 1, 1);               
	            }
	         ...
	         // Perform the Peelout:
	            if(Action = ActionPeelout && !KeyUp && PeeloutTimer == 12){
	               ...
	               PeeloutFlag  = 1;
	               PeeloutTimer = 0;
	               PlaySound(snd_character_peelout_release, global.SFXVolume, 1,1);        
