function scr_character_handle_monitors(argument0) {
	 if(argument0 == "Top"){
	          Monitor = scr_character_collision_bottom_object(x, y, Angle, spr_mask_big, obj_monitor);
	          if((Monitor && YSpeed >= 0 && ((Action = ActionJump) || Action = ActionRolling || Action = ActionNormal && Animation == "ROLL" && CharacterID != CharacterAmy && Action != ActionDrop))){
