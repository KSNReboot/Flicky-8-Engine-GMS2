...
/// Modify Physics.
 ...
 // Sonic and Tails Physics:
    if((CharacterID == CharacterSonic || CharacterID == CharacterTails || CharacterID == CharacterKnuckles || CharacterID == CharacterRay || CharacterID == CharacterMighty ) && CharacterState = CharacterNormal){
    ...
    if((CharacterID == CharacterSonic || CharacterID == CharacterTails || CharacterID == CharacterKnuckles || CharacterID == CharacterMighty || CharacterID == CharacterRay) && (CharacterState = CharacterSuper or CharacterState = CharacterHyper)){
       ...
       if(PhysicMode == "Underwater"){
          ...
          // Jumping Values:
             if(CharacterID == CharacterSonic || CharacterID == CharacterTails || CharacterID == CharacterMighty || CharacterID == CharacterRay){
                JumpStrength = -3.5;
             }            
             if(CharacterID == CharacterKnuckles){
                JumpStrength = -3
